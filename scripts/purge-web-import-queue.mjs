/**
 * Remove todos os jobs pendentes/ativos da fila BullMQ web-import.
 * Uso: pnpm purge:web-import
 */
...
const queue = new Queue('web-import', {
  connection: {
...
console.log(`Fila web-import — waiting: ${waiting}, active: ${active}, delayed: ${delayed}`);

await queue.obliterate({ force: true });
await queue.close();

console.log('Fila web-import purgada com sucesso.');
